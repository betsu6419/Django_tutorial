# Generated by Django 2.2.2 on 2019-06-27 13:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('kakeibo', '0002_auto_20190623_1303'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='kakeibo',
            name='result',
            field=models.CharField(max_length=500, verbose_name='高いかやすいか'),
        ),
        migrations.CreateModel(
            name='WeatherData',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='登録日時')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='kakeibo.Location', verbose_name='ロケーション')),
            ],
            options={
